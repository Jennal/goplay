...
const (
	...
	PKG_RPC_NOTIFY    = PKG_RPC | PKG_NOTIFY
	PKG_RPC_REQUEST   = PKG_RPC | PKG_REQUEST
	PKG_RPC_RESPONSE  = PKG_RPC | PKG_RESPONSE
	PKG_RPC_PUSH      = PKG_RPC | PKG_PUSH
	PKG_RPC_BROADCAST = PKG_RPC | 0x06
)
